...
namespace SpriteShatter {
    ...
    public class Shatter : MonoBehaviour {
        ...
        //Enumerated Types.
        public enum ColliderType { None, Circle, Box, Polygon };
        ...
        {
            {
                ...
                try
                {
                    sourcePixels = spriteRenderer.sprite.texture.GetPixels((int)spriteRenderer.sprite.rect.xMin, (int)spriteRenderer.sprite.rect.yMin,
                ...
                else
                {
                    ...
                    for (int i = 0; i < shatterGameObjectTransform.childCount; i++) //Add dustbehaviour to each particle
                    {
                        GameObject shatterObject = shatterGameObjectTransform.GetChild(i).gameObject;
                        shatterObject.AddComponent<DustBehaviour>();
                    }
